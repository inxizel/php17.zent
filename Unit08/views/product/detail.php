                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 hidden-xs">
                                    <div class="product-main-image">
                                        <div class="product-main-image__item"><img class="product-zoom" src='public/images/<?=$row['images']?>'  alt="" /></div>
                                ...
                                <div class="product-info col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="price-box product-info__price"><span class="price-box__new"><?=number_format($row['price'])?> vnđ</span> <span class="price-box__old"></span></div>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <div class="pull-left"><a href="?mod=cart&act=addToCart&code=<?=$row['code']?>"><button type="submit" class="btn btn--ys btn--xxl"><span class="icon icon-shopping_basket"></span> Add to cart</button></a></div>
                                    </div>
