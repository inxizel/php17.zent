									...
									<div class="product product--zoom">
										<div class="product__inside">
											...
											<div class="product__inside__image">
												<a href="index.php?mod=product&act=detail&code=<?=$row['code']?>"> <img src="public/images/<?=$row['images']?>" alt=""> </a> 
												<!-- quick-view --> 
											...
											<div class="product__inside__name">
												<h2><a href="?mod=product$act=detail$id=1"><?=$row['name']?></a></h2>
											</div>
											...
											<div class="product__inside__price price-box"><?=number_format($row['price'])?> vnđ</div>
											<!-- /product price --> 
											<!-- product review --> 
											<!-- visible only in row-view mode -->
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="?mod=product$act=detail$id=1"> <img src="images/product/product-9.jpg" alt=""> </a> 
												<!-- quick-view --> 
