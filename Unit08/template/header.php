				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-8 col-md-8 col-lg-6 col-xl-5 text-right">
							<!-- slogan start -->
							<div class="slogan"> <?php if(isset($_SESSION['user'])) echo "Xin chào ".$_SESSION['user']['name']; else "Bạn vui lòng đăng nhập";  ?> </div>
							<!-- slogan end --> 						
							<div class="settings">
								<!-- currency start -->
								...
								<div class="text-right">	
									...
									<div class="account link-inline">
										<div class="dropdown text-right">
											...
											<ul class="dropdown-menu dropdown-menu--xs-full">
												...
												<li><a href="user.php?mod=login&act=logout"  ><span class="icon icon-lock"></span>Logout</a></li>
									...
									<div class="cart link-inline">
										<div class="dropdown text-right">
											...
											<span class="badge badge--cart"><?php if(isset($_SESSION['cart'])) echo count($_SESSION['cart']); else echo 0;?> </span>
											</a>
											<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
												<div class="container">
													...
													<ul>
														<?php
															...
															foreach ($_SESSION['cart'] as $row1) :
																$tongtien += $row1['quantity'] * $row1['price'];
														?>
														<li class="cart__item">
															<div class="cart__item__image pull-left"><a href="#"><img src="public/images/<?=$row1['images']?>" alt=""/></a></div>
															...
															<div class="cart__item__info">
																<div class="cart__item__info__title">
																	<h2><a href="#"><?=$row1['name']?></a></h2>
																</div>
																<div class="cart__item__info__price"><span class="info-label">Price:</span><span><?=number_format($row1['price'])?> vnd</span></div>
																<div class="cart__item__info__qty"><span class="info-label">Qty:</span><input type="text" class="input--ys" value='<?=$row1['quantity']?>' /></div>
													...
													<div class="cart__bottom">
														<div class="cart__total">Cart subtotal: <span> <?=number_format($tongtien)?>vnđ</span></div>
														<a href="?mod=cart&act=checkout"><button class="btn btn--ys btn-checkout"> Checkout <span class="icon icon--flippedX icon-reply"></span></button></a>
														<a href="?mod=cart" class="btn btn--ys"><span class="icon icon-shopping_basket"></span> View Cart</a>
													</div>
												</div>
											</div>
										</div>
